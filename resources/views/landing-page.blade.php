...
<div class="body">
                    ...
                    <div class="header-column px-lg-3">
                        <div class="header-row">
                            <div class="header-logo">
                                <a href="index.html"><img alt="Porto" width="120" height="58" data-sticky-width="82" data-sticky-height="40" data-sticky-top="0" src={{asset("img/logo-default-slim-dark.png")}}></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="header-row justify-content-end justify-content-lg-start">
                            ...
                            <div class="d-flex">
                                <div class="d-none d-xxl-flex custom-header-1-extra-links">
                                    ...
                                    <a class="btn btn-primary font-weight-semibold text-3 py-3 border-radius p-relative bottom-1 custom-header-1-btn-1 btn-gradient" href="https://themeforest.net/checkout/from_item/4106987?license=regular&support=bundle_6month&ref=Okler" target="_blank"><span class="px-4 d-block ws-nowrap">Buy Now</span></a>
                                </div>
    ...
    <div role="main" class="main">
        <section class="section section-concept section-no-border section-dark section-angled section-angled-reverse pt-5 m-0" id="section-concept" style="background-image: {{ asset("img/landing/header_bg.jpg") }}; background-size: cover; background-position: center; animation-duration: 750ms; animation-delay: 300ms; animation-fill-mode: forwards;">
            <div class="section-angled-layer-bottom bg-light" style="padding: 8rem 0;"></div>
            <div class="container-fluid pt-5 mt-5">
                <div class="row custom-header-min-height-1 align-items-center h-100">
                    <div class="col-lg-7 col-xl-6">

                        <div class="col-half-section col-half-section-right custom-header-max-width-1 ms-auto justify-self-end">

                            <h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">PORTO HTML5 TEMPLATE</h5>
                            <h1 class="font-weight-bold text-12 line-height-2 mb-3">Multipurpose<br> Website <span class="highlighted-word highlighted-word-animation-1 highlighted-word-animation-1-2 highlighted-word-animation-1 highlighted-word-animation-1-light default-font font-weight-bold highlighted-word-animation-1-end">Template</span></h1>
                            <p class="custom-font-size-1 pt-2">Porto is simply the best choice for your new website.<br>The template is several years among the most popular in the world.</p>

                            <div class="d-flex counters pt-3">
                                <div class="custom-counter-1 pe-4">
                                    <div>
                                        <h3 data-append=" +" data-to="85" class="mb-0">
                                            0
                                        </h3>
                                ...
                                <div class="custom-counter-1 ps-3">
                                    <div>
                                        <h3 data-append=" K+" data-to="45" class="mb-0">
                                            0
                                        </h3>
                                        <svg version="1.2" xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 117 12" width="117" height="12">
                                            <g>
                    ...
                    <div class="col-10 col-lg-5 intro-img-slider text-right py-5 pt-lg-0 p-relative mx-auto">
                        <div class="d-inline-block ml-auto p-relative custom-banner-content-1">
                            <div class="d-flex align-items-center m-2 p-1">
                                <img src="img/landing/browser-icons-1.svg" alt="" width="26" height="26" />
                                <img src="img/landing/browser-icons-2.svg" alt="" class="ms-1" width="40" height="10" />
                            </div>
                            <div class="custom-banner-content-item-1 floating" data-floating-depth=".6" data-options='{"invertX": true,"invertY": true}'>
                                <img src="img/landing/color-picker.png" class="img-fluid" />
                            </div>

                            <div class="custom-banner-content-item-2 d-none d-xl-block bg-dark p-3">
                                <ul class="list-inline custom-list-icons-1 text-color-light m-0">
                                    <li class="list-inline-item ms-3">
                                        <span class="custom-list-icon bg-light text-color-dark negative-ls-1">
                                            B
                                        </span>
                                        <strong class="font-weight-semibold negative-ls-05">Bootstrap 5</strong>
                                    </li>
                                    <li class="list-inline-item ms-3">
                                        <span class="custom-list-icon bg-light text-color-dark negative-ls-1">
                                            <i class="fas fa-palette"></i>
                                        </span>
                                        <strong class="font-weight-semibold negative-ls-05">Skin Builder</strong>
                                    </li>
                                    <li class="list-inline-item ms-3">
                                        <span class="custom-list-icon bg-light text-color-dark negative-ls-1">
                                            <i class="fas fa-code"></i>
                                        </span>
                                        <strong class="font-weight-semibold negative-ls-05">Fast and Flexible</strong>
                                    </li>
                                </ul>
                            </div>

                            <div class="custom-banner-content-slider-1">
                                <div class="owl-carousel mb-0" data-plugin-options="{'items': 1, 'loop' : true, 'nav' : false, 'dots' : false, 'margin': 12, 'autoplay': true, 'autoplayTimeout': 2000, 'animateIn': 'fadeIn', 'animateOut': 'fadeOut', 'mouseDrag': false, 'touchDrag': false }">
                                    <figure class="mb-0">
                                        <a class="d-block" href="index.html#demos">
                                            <img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src= {{ asset("img/landing/intro-preview-1.jpg") }} />
                                        </a>
                                    </figure>
                                    <figure class="mb-0">
                                        <a class="d-block" href="index.html#demos">
                                            <img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src= {{ asset("img/landing/intro-preview-2.jpg") }} />
                                        </a>
                                    </figure>
                                    <figure class="mb-0">
                                        <a class="d-block" href="index.html#demos">
                                            <img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src= {{ asset("img/landing/intro-preview-3.jpg") }} />
                                        </a>
                                    </figure>
                                    <figure class="mb-0">
                                        <a class="d-block" href="index.html#demos">
                                            <img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src= {{ asset("img/landing/intro-preview-4.jpg") }} />
                                        </a>
                                    </figure>
                                    <figure class="mb-0">
                                        <a class="d-block" href="index.html#demos">
                                            <img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src= {{ asset("img/landing/intro-preview-5.jpg") }} />
                                        </a>
                                    </figure>
                                </div>
                            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8 col-lg-6 custom-header-bar position-relative py-4 pe-5 z-index-2">
                        <div>
                            ...
                            <p class="position-relative text-center font-weight-normal mb-1">* 45K+ Trust Porto - Since 2013</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="demos" class="section section-no-border section-light position-relative z-index-3 pt-0 m-0">
            <div class="container-fluid position-relative">
                <div class="filter-wrapper py-4 bg-light left-0 z-index-3 w-100" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'padding': {'top': 70}}">

                    <div class="row">
                        <div class="col-lg-8">
                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0" data-appear-animation-duration="750">
                                <ul class="nav nav-pills sort-source sort-source-style-3 mb-0" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*', 'useHash': false, 'filterFieldId': 'demoFilter'}">
                                    <li class="nav-item active" data-option-value="*"><a class="nav-link ms-0 custom-nav-link active" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">Show All</a></li>
                                    <li class="nav-item" data-option-value=".new"><a class="nav-link custom-nav-link" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">NEW</a></li>
                                    <li class="nav-item" data-option-value=".classic"><a class="nav-link custom-nav-link" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">Classic</a></li>
                                    <li class="nav-item" data-option-value=".shop"><a class="nav-link custom-nav-link" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">Shop</a></li>
                                    <li class="nav-item" data-option-value=".onepage"><a class="nav-link custom-nav-link" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">One Page</a></li>
                                    <li class="nav-item" data-option-value=".business"><a class="nav-link custom-nav-link" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">Business</a></li>
                                    <li class="nav-item" data-option-value=".blog"><a class="nav-link custom-nav-link" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">Blog</a></li>
                                    <li class="nav-item" data-option-value=".portfolio"><a class="nav-link custom-nav-link" href="#demos" data-hash data-hash-offset="0" data-hash-offset-lg="90">Portfolio</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row portfolio-list sort-destination sort-destination-margin sort-destination-items-hardware-acc overflow-visible mt-4" data-sort-id="portfolio">
                            ...
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-classic.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 8">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-8.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item onepage" data-sort-search="one page">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-one-page.jpg") }} >
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="business consulting 3">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-business-consulting-3.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="auto services">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-auto-services.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="startup agency">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-startup-agency.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="construction">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-construction.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="construction 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-construction-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="creative agency">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-creative-agency-1.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="personal portfolio">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-personal-portfolio-1.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="personal portfolio">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-personal-portfolio-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="personal portfolio">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-personal-portfolio-3.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="seo 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-seo-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="seo 3">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-seo-3.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="architecture 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-architecture-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="cleaning services">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-cleaning-services.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="insurance">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-insurance.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="business consulting 4">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-business-consulting-4.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="business consulting 5">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-business-consulting-5.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="transportation logistic">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-transportation-logistic.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="renewable energy">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-renewable-energy.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="industry factory">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-industry-factory.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="law firm 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-law-firm-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="business consulting">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-business-consulting.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="business consulting 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-business-consulting-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="medical">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-medical.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="medical 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-medical-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="dentist">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-dentist.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="finance">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-finance.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="seo">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-seo.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="it services">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-it-services.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item shop" data-sort-search="product landing">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-product-landing.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="coffee shop">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-coffee.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="sass">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-sass.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="architecture interior design">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-architecture-interior.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="beauty salon">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-beauty-salon.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="barber shop">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-barber.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="education">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-education.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="digital agency">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-digital-agency.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="digital agency 2 light">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-digital-agency-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="digital agency 2 dark">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-digital-agency-2-dark.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="app landing">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-app-landing.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="law firm">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-law-firm.jpg") }}>
                            ...
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    ...
                                    <div class="owl-carousel nav-dark show-nav-hover" data-plugin-options="{'items': 1, 'loop': true, 'nav': true, 'dots': false, 'autoplay': true, 'autoplayTimeout': 3000, 'autoplayHoverPause': true}">
                                        <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                            <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-resume.jpg") }}>
                                                <a href="demo-resume.html" target="_blank"></a>
                                            </span>
                                        </span>

                                        <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                            <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-resume-blue.jpg") }}>
                                                <a href="demo-resume-blue.html"></a>
                                            </span>
                                        </span>

                                        <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                            <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-resume-red.jpg") }}>
                                                <a href="demo-resume-red.html"></a>
                                            </span>
                                        </span>

                                        <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                            <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-resume-green.jpg") }}>
                                                <a href="demo-resume-green.html"></a>
                                            </span>
                                        </span>

                                        <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                            <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src= {{ asset("img/previews/preview-resume-dark.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="hotel">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-hotel.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="hotel">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-hotel-boxed.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="real estate">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-real-estate.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item creative business" data-sort-search="event">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-event.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="restaurant">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-restaurant.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="gym">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-gym.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item onepage creative business" data-sort-search="band">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-band.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item onepage creative" data-sort-search="one page agency">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-one-page-agency.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="photography">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-photography.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="photography 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-photography-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="photography 3">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-photography-3.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="church">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-church.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="wedding">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-wedding.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 1">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 3">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-3.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 4">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-4.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 5">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-5.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 6">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-6.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 7">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-7.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 9">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-9.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 10">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-10.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 11">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-11.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 12">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-12.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 13">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-13.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 14">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-14.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 15">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-15.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 16">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-16.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 17">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-17.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 18">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-18.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 19">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-19.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 20">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-20.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 21">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-21.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 1">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-portfolio.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-portfolio-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 3">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-portfolio-3.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 4">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-portfolio-4.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 5">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-portfolio-5.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 1">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-blog.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 2">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-blog-2.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 3">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-blog-3.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 4">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-blog-4.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 5">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-blog-5.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="hosting">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-corporate-hosting.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic color">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-classic-color.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic light">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-classic-light.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic video">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-classic-video.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic video light">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-classic-video-light.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="boxed">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-boxed.jpg") }}>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="rtl">
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src={{ asset("img/previews/preview-rtl.jpg") }}>
        ...
        <section class="section border-0 section-dark section-angled section-angled-reverse section-funnel m-0 position-relative overflow-visible" style="background-image: url(img/landing/porto_performance_bg.png); background-size: 100%; background-position: top; background-repeat: no-repeat;" data-bg-src="">
        ...
        <section class="section border-0 m-0 bg-dark section-dark" style="background-size: 100%; background-position: top;" data-bg-src="img/landing/header_builder_bg.jpg">
            <div class="container">
        ...
        <section class="section section-funnel position-relative border-0 pt-0 m-0">
            <div class="container pb-5 mb-5">
                <h2 class="fotn-weight-extra-bold mb-1 text-center">
                    <b class="text-13 d-block line-height-1 font-weight-extra-bold appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="250" data-appear-animation-duration="750">45K+</b>
