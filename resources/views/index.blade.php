...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href={{ asset("theme-elements.css") }}>
		<link rel="stylesheet" href={{ asset("theme-blog.css") }}>
		<link rel="stylesheet" href={{ asset("theme-shop.css") }}>

		<!-- Demo CSS -->
		<link rel="stylesheet" href={{ asset("demos/demo-landing.css") }}>

		<!-- Skin CSS -->
		<link id="skinCSS" rel="stylesheet" href={{ asset("skins/skin-landing.css") }}>
		...
		<div class="body">
										...
										<div class="owl-carousel mb-0" data-plugin-options="{'items': 1, 'loop' : true, 'nav' : false, 'dots' : false, 'margin': 12, 'autoplay': true, 'autoplayTimeout': 2000, 'animateIn': 'fadeIn', 'animateOut': 'fadeOut', 'mouseDrag': false, 'touchDrag': false }">
											<figure class="mb-0">
												<a class="d-block" href="index.html#demos">
													<img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src="img/landing/intro-preview-1.jpg" />
												</a>
											</figure>
											<figure class="mb-0">
												<a class="d-block" href="index.html#demos">
													<img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src="img/landing/intro-preview-2.jpg" />
												</a>
											</figure>
											<figure class="mb-0">
												<a class="d-block" href="index.html#demos">
													<img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src="img/landing/intro-preview-3.jpg" />
												</a>
											</figure>
											<figure class="mb-0">
												<a class="d-block" href="index.html#demos">
													<img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src="img/landing/intro-preview-4.jpg" />
												</a>
											</figure>
											<figure class="mb-0">
												<a class="d-block" href="index.html#demos">
													<img alt="" class="d-block ml-auto img-fluid border-radius" loading="lazy" src="img/landing/intro-preview-5.jpg" />
												</a>
											</figure>
										</div>
									</div>
						...
						<div class="row portfolio-list sort-destination sort-destination-margin sort-destination-items-hardware-acc overflow-visible mt-4" data-sort-id="portfolio">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="creative agency">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
										<div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="img/previews/preview-creative-agency-1.jpg">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="personal portfolio">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
										<div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="img/previews/preview-personal-portfolio-1.jpg">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="personal portfolio">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
										<div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="img/previews/preview-personal-portfolio-2.jpg">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio new" data-sort-search="personal portfolio">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
										<div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="img/previews/preview-personal-portfolio-3.jpg">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="seo 3">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
										<div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="img/previews/preview-seo-3.jpg">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="business consulting 5">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
										<div class="portfolio-item hover-effect-1 text-center">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="img/previews/preview-business-consulting-5.jpg">
			...
			<footer id="footer" class="bg-color-dark-scale-2 border border-end-0 border-start-0 border-bottom-0 border-color-light-3 mt-0">
				<div class="container text-center my-3 py-5">
					<a href="index.html">
						<img src="img/lazy.png" data-src="img/landing/logo.png" width="102" height="45" class="appear-animation lazyload mb-4" alt="Porto" data-appear-animation="fadeIn" data-appear-animation-delay="300">
					</a>
				...
				<div class="copyright bg-dark py-4">
					<div class="container text-center py-2">
						<p class="mb-0 text-2">Copyright 2013 - 2023 - Porto - All Rights Reserved</p>
					</div>
				</div>
			</footer>
		</div>
